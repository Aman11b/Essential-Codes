...
> configure store function basically wraps around create store and adds a few fucntionalities to it,it automatically will combine our reducers,add the thunk middleware,setup developer tools
